...
public class SubscriptionCreationWorkflow extends WorkflowExecutor {

    private static final Log log = LogFactory.getLog(SubscriptionCreationWorkflow.class);
    ...
    public void complete(WorkflowDTO workflowDTO) throws WorkflowException {
        ...
        if (WorkflowStatus.APPROVED.equals(workflowDTO.getStatus())) {
            ...
            try {
                ...
                log.error("Could not complete subscription creation workflow with 'APPROVED' state", e);
                throw new WorkflowException("Could not complete subscription creation workflow with 'APPROVED' state", e);
            }
        }
            ...
            try {
                ...
                log.error("Could not complete subscription creation workflow with 'REJECTED' state", e);
                throw new WorkflowException("Could not complete subscription creation workflow with 'REJECTED' state", e);
            }
        }
    }
